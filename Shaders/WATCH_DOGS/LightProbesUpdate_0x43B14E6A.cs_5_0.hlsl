...
SamplerComparisonState LongRangeShadowSampler_s : register(s0);
Texture2D<float4> LightData__LongRangeShadowVolumeTexture__TexObj__ : register(t0);
StructuredBuffer<SRadianceTransferProbeCompute>  TransferProbes : register(t1);// Input buffer of probes to process
